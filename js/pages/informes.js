...
let trTablaTodo = document.getElementById("tablas-todo");

while (trTablaTodo.firstChild) {
  trTablaTodo.removeChild(trTablaTodo.firstChild);
}
...
function actualizarMapa(distritoId) {
  ...
  if (provinciaEncontrada) {
    imagenMapa.innerHTML = `<div id="mapas-svg" style="width: 300px">${provinciaEncontrada.svg}</div>`;
    return imagenMapa;
  } else {
    console.log(
...
function mostrarInformacionCuadros(
  ...
  contenedorCuadros.innerHTML = `<div class="iconos-datos-generales">
  ...
  <div class="electores">
      ...
      <div class="palabras-datos-generales"><span class="bold">Electores:</span><br>
          <p id="electores-porcentaje">${electores}</p>
          </div>
  </div>

  <div class="participacion-sobre-escrutado">
      <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
          xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="841.889px"
          height="595.281px" viewBox="0 0 841.889 595.281"
          enable-background="new 0 0 841.889 595.281" xml:space="preserve"
      ...
      <div class="palabras-datos-generales"><span class="bold">Participación sobre
              escrutado:</span><br>
              <p id="participacion-porcentaje">${participacionSobreEscrutado}%</p>
      </div>
  </div>
</div>
  `;
